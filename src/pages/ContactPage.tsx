      ...
      <main className="page__content">
        <article className="page__article">
          ...
          <nav className="contact-links" aria-label="Contact links">
            <a href="mailto:debora.souza@ccc.ufcg.edu.br" className="contact-link">
              ...
              <span className="contact-link__label">debora.souza@ccc.ufcg.edu.br</span>
              <span className="contact-link__hint">Email</span>
            </a>

            <a href="https://github.com/deboraleda" target="_blank" rel="noopener noreferrer" className="contact-link">
              <span className="contact-link__icon" aria-hidden="true">
              ...
              <span className="contact-link__label">github.com/deboraleda</span>
              <span className="contact-link__hint">GitHub</span>
            </a>

            <a href="https://www.linkedin.com/in/deboraleda/" target="_blank" rel="noopener noreferrer" className="contact-link">
              <span className="contact-link__icon" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <span className="contact-link__label">linkedin.com/in/deboraleda</span>
